...
const char *CBreakable::pSpawnObjects[] =
{
	NULL,				// 0
	"weapon_BrownBess", // 1
	"weapon_Revolutionnaire",	// 2
	"weapon_Charleville",	// 3
	"weapon_Pennsylvania",	// 4
	"weapon_PistolA",	// 5
	"weapon_PistolB",	// 6
	"weapon_Sabre",		// 7
	"weapon_Knife",		// 8
...
void CBreakable::Die( void )
{
	...
	fvol = RANDOM_FLOAT(0.85, 1.0) + abs((int)pev->health);
...
//ben - ta to the sluggo dewds for this :)
void CBreakable::Reset()
{
	Spawn();
	pev->effects &= ~EF_NODRAW;
