...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /base:"0xc700000" /subsystem:windows /dll /incremental:yes /map /debug /machine:I386 /def:".\hl.def" /out:".\Releasehl/bg.dll" /MAPINFO:LINES /MAPINFO:EXPORTS
...
# ADD LINK32 user32.lib advapi32.lib /nologo /base:"0xc700000" /subsystem:windows /dll /map /debug /machine:I386 /def:".\bg.def" /out:"C:\Games\Steam\SteamApps\blackpanther@bgmod.com\half-life\bg-dev\dlls\bg.dll" /implib:".\Debug\hl.lib"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /base:"0xc700000" /subsystem:windows /dll /profile /map /debug /machine:I386 /def:".\hl.def" /out:"C:\Games\Halflife\bg-dev\dlls\bg.dll" /MAPINFO:LINES /MAPINFO:EXPORTS
