...
//Line entities
LINK_ENTITY_TO_CLASS( info_british_line, CBaseDMStart);
LINK_ENTITY_TO_CLASS( info_american_line, CBaseDMStart);
...
void CBaseDelay :: SUB_UseTargets( CBaseEntity *pActivator, USE_TYPE useType, float value )
{
	...
	if (m_flDelay != 0)
	{
		...
		// HACKHACK
		// This wasn't in the release build of Half-Life.  We should have moved m_hActivator
		// into this class but changing member variable hierarchy would break save/restore
		// without some ugly code. This code is not as ugly as that code
...
{
	//Ben
//	DEFINE_FIELD( CBaseToggle, m_iTeam, FIELD_INTEGER ),
	//Ben
...
void CBaseToggle::KeyValue( KeyValueData *pkvd )
{
	...
	else if(FStrEq(pkvd->szKeyName, "team_trigger"))
	{
