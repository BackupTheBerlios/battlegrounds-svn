...
// Misc. Prototypes
extern Vector		UTIL_DistanceBetween	(Vector v1, Vector v2);
...
extern void			UTIL_LogPrintf( LOG_LEVEL iLogLevel, char *fmt, ... );
...
#define SF_TRIGGER_PUSHABLES		4// pushables can fire this trigger
