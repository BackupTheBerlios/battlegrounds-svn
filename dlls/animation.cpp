...
int LookupActivityHeaviest( void *pmodel, entvars_s *pev, int activity )
{
	studiohdr_t *pstudiohdr;
...
bool GetSequenceFlags( void *pmodel, entvars_t *pev )
{
	studiohdr_t *pstudiohdr;
...
float SetController( void *pmodel, entvars_t *pev, int iController, float flValue )
{
	...
	int setting = 255 * (int)(flValue - pbonecontroller->start) / (int)(pbonecontroller->end - pbonecontroller->start);
...
float SetBlending( void *pmodel, entvars_t *pev, int iBlender, float flValue )
{
	...
	int setting = 255 * (int)(flValue - pseqdesc->blendstart[iBlender]) / (int)(pseqdesc->blendend[iBlender] - pseqdesc->blendstart[iBlender]);
