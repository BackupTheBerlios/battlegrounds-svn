...
float g_ColorGreen[3]	= { 0.0781, 0.377, 0.0781 };
...
float *GetClientColor( int clientIndex )
{
	...
	case 3: return g_ColorGreen;
	case 4: return g_ColorYellow;
...
int CHudDeathNotice :: MsgFunc_DeathMsg( const char *pszName, int iSize, void *pbuf )
{
	...
	strncat( killedwith, READ_STRING(30), 32 );

	char killedwith2[32];
	strcpy( killedwith2, "d_" );
	strncat( killedwith2, READ_STRING(30), 32 );
	...
	else
	{
		...
		if ( !strcmp( killedwith2, "d_teammate" ) )
