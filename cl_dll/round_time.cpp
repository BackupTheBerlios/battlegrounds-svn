...
int CHudClock::Draw(float flTime)
{
	...
	x = 94;
	x = gHUD.DrawHudNumber(x, y, DHN_2DIGITS | DHN_DRAWZERO, m_iCurrentClockTime/60, r, g, b, 3);

	// Draw the ":" between the MM and SS
	x = gHUD.DrawHudString(x, y, ScreenWidth, ":", r, g, b);

	x = gHUD.DrawHudNumber(x, y, DHN_2DIGITS | DHN_PREFIXZERO, m_iCurrentClockTime%60, r, g, b, 3);
