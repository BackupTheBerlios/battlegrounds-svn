...
#define RGB_BLUEISH 0x000066FF // 0, 102, 255
...
private:
	...
	HSPRITE m_hIconRed;
	HSPRITE m_hIconBlue;
	wrect_t *m_SpriteAreaIconWhite;
	wrect_t *m_SpriteAreaIconRed;
	wrect_t *m_SpriteAreaIconBlue;
	bool m_bInvolvedInCapture;
	int m_iInvolvedInCaptureId;
	HSPRITE m_hClock;
	wrect_t *m_SpriteAreaClock;
	HSPRITE m_hFillUp;
	wrect_t *m_SpriteAreaFillUp;
};
