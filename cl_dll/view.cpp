...
void V_DriftPitch ( struct ref_params_s *pparams )
{
	...
	if (pd.nodrift)
	{
		if ( fabs( pparams->cmd->forwardmove ) < cl_forwardspeed )
			pd.driftmove = 0;
		else
...
void V_CalcViewRoll ( struct ref_params_s *pparams )
{
	...
	if ( g_flHealth <= 0.0 && ( pparams->viewheight[2] != 0 ) )
	{
...
void V_CalcNormalRefdef ( struct ref_params_s *pparams )
{
	...
	//FIXME		I_Error ("steptime < 0");
		...
		if (pparams->simorg[2] - oldz > 11)
			oldz = pparams->simorg[2]- 11;
...
int V_FindViewModelByWeaponModel(int weaponindex)
{
	...
	static char * modelmap[][2] =	{
		...
		{ "models/p_sabre.mdl",			"models/v_sabre.mdl"	},
		{ "models/p_tomahawk.mdl",		"models/v_tomahawk.mdl"	},
		{ "models/p_brownbess.mdl",		"models/v_brownbess.mdl"		},
		{ "models/p_pennsylvania.mdl",	"models/v_pennsylvania.mdl"		},
		{ "models/p_charleville.mdl",	"models/v_charleville.mdl"		},
		{ "models/p_revolutionnaire.mdl","models/v_revolutionnaire.mdl"	},
		{ "models/p_pistol_british.mdl","models/v_pistol_british.mdl"	},
		{ "models/p_pistol_american.mdl","models/v_pistol_american.mdl"	},
		{ NULL, NULL } };
...
{
	// OPENGL only hintbox
	gHintBox.displaymode = pparams->hardware;
