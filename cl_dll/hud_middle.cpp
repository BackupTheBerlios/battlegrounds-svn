...
int CHudMiddle::Draw(float flTime)
{
	...
	if (iBritish_1000)
	{
		h = gHUD.DrawHudNumber(x, y, DHN_2DIGITS | DHN_DRAWZERO, iBritish_1000, r, g, b, 2);
	}

	if (iBritish_100 || iBritish_1000)
	{
		x += 8;
		h = gHUD.DrawHudNumber(x, y, DHN_2DIGITS | DHN_DRAWZERO, iBritish_100, r, g, b, 2);
	}

	if (iBritish_10 || iBritish_100  || iBritish_1000)
	{
		x += 8;
		h = gHUD.DrawHudNumber(x, y, DHN_2DIGITS | DHN_DRAWZERO, iBritish_10, r, g, b, 2);
	}

	x += 8;
	h = gHUD.DrawHudNumber(x, y, DHN_2DIGITS | DHN_DRAWZERO, iBritish_1, r, g, b, 2);
	...
	if (iAmericans_1000) 
	{
		h = gHUD.DrawHudNumber(x, y, DHN_2DIGITS | DHN_DRAWZERO, iAmericans_1000, r, g, b, 2);
	}

	if (iAmericans_100 || iAmericans_1000)
	{
		x += 8;
		h = gHUD.DrawHudNumber(x, y, DHN_2DIGITS | DHN_DRAWZERO, iAmericans_100, r, g, b, 2);
	}
	if (iAmericans_10 || iAmericans_100  || iAmericans_1000)
	{
		x += 8;
		h = gHUD.DrawHudNumber(x, y, DHN_2DIGITS | DHN_DRAWZERO, iAmericans_10, r, g, b, 2);
	}

	x += 8;
	h = gHUD.DrawHudNumber(x, y, DHN_2DIGITS | DHN_DRAWZERO, iAmericans_1, r, g, b, 2);
