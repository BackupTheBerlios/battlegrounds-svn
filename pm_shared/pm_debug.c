...
{
	const vec3_t VEC_HULL_MIN = {-16, -16, -36};
	const vec3_t VEC_HULL_MAX = { 16,  16,  36};
	const vec3_t VEC_DUCK_HULL_MIN = {-16, -16, -18};
	const vec3_t VEC_DUCK_HULL_MAX = { 16,  16,  36};

	VectorCopy(VEC_HULL_MIN, pmove->player_mins[0]);
	VectorCopy(VEC_HULL_MAX, pmove->player_maxs[0]);
	VectorCopy(VEC_DUCK_HULL_MIN, pmove->player_mins[1]);
	VectorCopy(VEC_DUCK_HULL_MAX, pmove->player_maxs[1]);
}
